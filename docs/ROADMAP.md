...
| What does powering the modem off save over radio low-power, during a blank? | `MODEM_RAIL_OFF_ON_BLANK=1`, A/B/A inside the blank (the 0.325 W already measured is against a connected modem) |
